...
function Lottery() {
    ...
    return (
        <div className="container">
            <h2 className="text-center title">Lottery</h2>
            <div className="containBtnDraw">
                <button className="btnDraw" onClick={generateWinningNumbers}>Draw numbers</button>
            </div>
            {isLoading && 
                <div>
                    <p className="dip">Draw in progress..</p>
                </div>
            }
